...
This shows the distribution of number of individual(inflow) i.e. migrantion variable, which highly right-skewed. Most of the data are concentrated on the left side of the distribution. 
