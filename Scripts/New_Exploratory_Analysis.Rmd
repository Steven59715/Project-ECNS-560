...
### finding 2:  Distribution Patterns of Migration and Housing Prices Across States and Time
...
ggplot(clean_data, aes(x = YEAR, y = LOG_MIGRATION, 
  ...
  geom_point() +
  labs(title = "Trend of Migrations Inflow by Year", x = "YEAR", y = "Migration Inflow (Log Transformed") +
...
ggplot(clean_data, aes(x = YEAR, y = LOG_VALUE, 
  ...
  #Add points to represent LOG_MIGRATION at each YEAR
  geom_point() +
  labs(title = "Trend of Housing Prices by Year", x = "YEAR", y = "Housing Prices (Log Transformed)") +
  theme(legend.position = "none")
```
